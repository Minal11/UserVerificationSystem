...
<form action="GetUser" method="post">
	<div class="leftpanel">
     ...
     <label>Enter Username</label><input type="text" name="userid" width="100px"/>
     
       
            <input class="btn btn-primary" type="submit" value="Next" name="next" align="middle" onClick="securityQ.html" >
